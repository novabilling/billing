...
namespace NovaBilling\Currencies;

use Psr\Http\Client\ClientInterface;
use NovaBilling\Core\Client\RawClient;
use NovaBilling\Types\CurrencyResponse;
    ...
    public function list(?array $options = null): array
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return JsonDecoder::decodeArray($json, [CurrencyResponse::class]); // @phpstan-ignore-line
            }
