...
use NovaBilling\Types\UsageEventResponse;
use JsonException;
use NovaBilling\Events\Requests\BatchEventsDto;
use NovaBilling\Types\BatchEventResponse;
use NovaBilling\Events\Requests\GetBySubscriptionEventsRequest;
use NovaBilling\Types\PaginatedUsageEventResponse;
...
class EventsClient
{
     ...
     */
    public function list(?array $options = null): void
    {
     ...
     * @throws NovabillingApiException
     */
    public function create(CreateEventDto $request, ?array $options = null): UsageEventResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return UsageEventResponse::fromJson($json);
            }
     ...
     * @throws NovabillingApiException
     */
    public function createBatch(BatchEventsDto $request, ?array $options = null): BatchEventResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return BatchEventResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new NovabillingException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     * @throws NovabillingApiException
     */
    public function get(string $id, ?array $options = null): UsageEventResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @param GetBySubscriptionEventsRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     *   bodyProperties?: array<string, mixed>,
     * } $options
     * @return PaginatedUsageEventResponse
     * @throws NovabillingException
     * @throws NovabillingApiException
     */
    public function getBySubscription(string $subscriptionId, GetBySubscriptionEventsRequest $request = new GetBySubscriptionEventsRequest(), ?array $options = null): PaginatedUsageEventResponse
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return PaginatedUsageEventResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new NovabillingException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
