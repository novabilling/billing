...
namespace NovaBilling\Charges;

use Psr\Http\Client\ClientInterface;
use NovaBilling\Core\Client\RawClient;
use NovaBilling\Charges\Requests\ListChargesRequest;
use NovaBilling\Types\ChargeResponse;
...
use NovaBilling\Charges\Requests\CreateChargeDto;
use NovaBilling\Charges\Requests\UpdateChargeDto;
...
class ChargesClient
{
     ...
     *
     * @param ListChargesRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     */
    public function list(ListChargesRequest $request = new ListChargesRequest(), ?array $options = null): array
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return JsonDecoder::decodeArray($json, [ChargeResponse::class]); // @phpstan-ignore-line
            }
     ...
     * @throws NovabillingApiException
     */
    public function create(CreateChargeDto $request, ?array $options = null): ChargeResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws NovabillingApiException
     */
    public function get(string $id, ?array $options = null): ChargeResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws NovabillingApiException
     */
    public function delete(string $id, ?array $options = null): ChargeResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws NovabillingApiException
     */
    public function update(string $id, UpdateChargeDto $request = new UpdateChargeDto(), ?array $options = null): ChargeResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws NovabillingApiException
     */
    public function getByPlan(string $planId, ?array $options = null): array
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
