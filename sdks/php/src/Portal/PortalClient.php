...
use JsonException;
use NovaBilling\Portal\Requests\GetInvoicesPortalRequest;
use NovaBilling\Types\PaginatedInvoiceResponse;
use NovaBilling\Types\CheckoutResponse;
use NovaBilling\Portal\Requests\GetPaymentsPortalRequest;
...
class PortalClient
{
     ...
     *
     * @param string $externalId Customer external ID (your app user ID)
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     */
    public function getBilling(string $externalId, ?array $options = null): void
    {
     ...
     * @throws NovabillingApiException
     */
    public function getSubscriptions(string $externalId, ?array $options = null): array
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     *
     * @param string $externalId Customer external ID
     * @param GetInvoicesPortalRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws NovabillingApiException
     */
    public function getInvoices(string $externalId, GetInvoicesPortalRequest $request = new GetInvoicesPortalRequest(), ?array $options = null): PaginatedInvoiceResponse
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
     ...
     * @throws NovabillingApiException
     */
    public function createCheckout(string $externalId, string $invoiceId, ?array $options = null): CheckoutResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     *
     * @param string $externalId Customer external ID
     * @param GetPaymentsPortalRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws NovabillingApiException
     */
    public function getPayments(string $externalId, GetPaymentsPortalRequest $request = new GetPaymentsPortalRequest(), ?array $options = null): PaginatedPaymentResponse
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
        if ($request->page != null) {
