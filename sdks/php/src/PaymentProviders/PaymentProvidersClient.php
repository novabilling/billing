...
namespace NovaBilling\PaymentProviders;

use Psr\Http\Client\ClientInterface;
use NovaBilling\Core\Client\RawClient;
use NovaBilling\Types\PaymentProviderResponse;
...
use NovaBilling\PaymentProviders\Requests\CreateProviderDto;
use NovaBilling\PaymentProviders\Requests\UpdateProviderDto;
use NovaBilling\Types\ProviderTestResponse;

class PaymentProvidersClient
{
    /**
     * @var array{
     *   baseUrl?: string,
     ...
     * } $options
     * @return array<PaymentProviderResponse>
    ...
    public function list(?array $options = null): array
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return JsonDecoder::decodeArray($json, [PaymentProviderResponse::class]); // @phpstan-ignore-line
            }
     ...
     *
     * @param CreateProviderDto $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws NovabillingApiException
     */
    public function configure(CreateProviderDto $request, ?array $options = null): PaymentProviderResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return PaymentProviderResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new NovabillingException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     * @throws NovabillingApiException
     */
    public function get(string $id, ?array $options = null): PaymentProviderResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws NovabillingApiException
     */
    public function delete(string $id, ?array $options = null): PaymentProviderResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     *
     * @param string $id Payment provider ID
     * @param UpdateProviderDto $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws NovabillingApiException
     */
    public function update(string $id, UpdateProviderDto $request = new UpdateProviderDto(), ?array $options = null): PaymentProviderResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws NovabillingApiException
     */
    public function testConnection(string $id, ?array $options = null): ProviderTestResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return ProviderTestResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new NovabillingException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
