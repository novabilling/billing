...
namespace NovaBilling\Webhooks;

use Psr\Http\Client\ClientInterface;
use NovaBilling\Core\Client\RawClient;
use NovaBilling\Webhooks\Requests\WebhooksControllerPaystackRequest;
...
use NovaBilling\Webhooks\Requests\WebhooksControllerFlutterwaveRequest;
use NovaBilling\Webhooks\Requests\WebhooksControllerStripeRequest;
...
class WebhooksClient
{
     ...
     *
     * @param WebhooksControllerPaystackRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     */
    public function webhooksControllerPaystack(WebhooksControllerPaystackRequest $request, ?array $options = null): void
    {
        $options = array_merge($this->options, $options ?? []);
        $headers = [];
        $headers['x-paystack-signature'] = $request->paystackSignature;
        try {
     ...
     *
     * @param WebhooksControllerFlutterwaveRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws NovabillingApiException
     */
    public function webhooksControllerFlutterwave(WebhooksControllerFlutterwaveRequest $request = new WebhooksControllerFlutterwaveRequest(), ?array $options = null): void
    {
        $options = array_merge($this->options, $options ?? []);
        $headers = [];
        if ($request->verifHash != null) {
            $headers['verif-hash'] = $request->verifHash;
        }
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
     ...
     * @throws NovabillingApiException
     */
    public function webhooksControllerDpo(?array $options = null): void
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws NovabillingApiException
     */
    public function webhooksControllerPayu(?array $options = null): void
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws NovabillingApiException
     */
    public function webhooksControllerPesapal(?array $options = null): void
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     *
     * @param WebhooksControllerStripeRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws NovabillingApiException
     */
    public function webhooksControllerStripe(WebhooksControllerStripeRequest $request, ?array $options = null): void
    {
        $options = array_merge($this->options, $options ?? []);
        $headers = [];
        $headers['stripe-signature'] = $request->stripeSignature;
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Default_->value,
