...
namespace NovaBilling.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static NovaBilling.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new NovaBilling.Core.MultipartFormRequest
        {
