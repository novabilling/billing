...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::NovaBilling.Core.ApiResponse> SendRequestAsync(
        global::NovaBilling.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::NovaBilling.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::NovaBilling.Core.ApiResponse
            {
    ...
    private static string BuildUrl(global::NovaBilling.Core.BaseRequest request)
    {
