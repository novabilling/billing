...
@JsonDeserialize(
    builder = PaginatedInvoiceResponse.Builder.class
)
public final class PaginatedInvoiceResponse {
  ...
  private PaginatedInvoiceResponse(List<InvoiceResponse> data, PaginationMeta meta,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PaginatedInvoiceResponse && equalTo((PaginatedInvoiceResponse) other);
  }
  ...
  private boolean equalTo(PaginatedInvoiceResponse other) {
  ...
  public interface MetaStage {
    ...
    Builder from(PaginatedInvoiceResponse other);
  }

  public interface _FinalStage {
    PaginatedInvoiceResponse build();
  ...
  public static final class Builder implements MetaStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(PaginatedInvoiceResponse other) {
      data(other.getData());
      meta(other.getMeta());
      return this;
    }
    ...
    @java.lang.Override
    public PaginatedInvoiceResponse build() {
      return new PaginatedInvoiceResponse(data, meta, additionalProperties);
    }
  }
}
