...
public final class RequestOptions {
  ...
  private RequestOptions(String token, String authorization, Optional<Integer> timeout,
  ...
  public static class Builder {
    ...
    public RequestOptions build() {
      return new RequestOptions(token, authorization, timeout, timeoutTimeUnit, headers, headerSuppliers, queryParameters, queryParameterSuppliers);
    }
  }
}
