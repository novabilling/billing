...
public struct PaginatedPlanOverrideResponse: Codable, Hashable, Sendable {
    public let data: [PlanOverrideResponse]
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.data = try container.decode([PlanOverrideResponse].self, forKey: .data)
