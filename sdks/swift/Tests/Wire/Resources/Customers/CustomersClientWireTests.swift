...
@Suite("CustomersClient Wire Tests") struct CustomersClientWireTests {
    @Test func list1() async throws -> Void {
        ...
        let expectedResponse = PaginatedCustomerResponse(
            data: [
                CustomerResponse(
                    id: "clx1234567890",
                    externalId: "user_12345",
        ...
        let response = try await client.customers.list(requestOptions: RequestOptions(additionalHeaders: stub.headers))
    ...
    @Test func getSubscriptions1() async throws -> Void {
        ...
        let response = try await client.customers.getSubscriptions(
            id: "id",
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
        )
        try #require(response == expectedResponse)
    ...
    @Test func getInvoices1() async throws -> Void {
        ...
        let response = try await client.customers.getInvoices(
            id: "id",
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
        )
        try #require(response == expectedResponse)
    ...
    @Test func getPayments1() async throws -> Void {
        ...
        let response = try await client.customers.getPayments(
            id: "id",
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
        )
        try #require(response == expectedResponse)
