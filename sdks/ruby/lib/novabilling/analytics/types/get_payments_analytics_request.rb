...
module Novabilling
  module Analytics
    module Types
      class GetPaymentsAnalyticsRequest < Internal::Types::Model
        ...
        field :group_by, -> { Novabilling::Analytics::Types::GetPaymentsAnalyticsRequestGroupBy }, optional: true, nullable: false, api_name: "groupBy"
