...
module Novabilling
  module APIKeys
    class Client
      ...
      #
      # @return [Array[Novabilling::Types::APIKeyResponse]]
      ...
      # Generate a new API key with specified scopes. The full key is returned only once in the response — store it
      # securely.
      #
      # @param request_options [Hash]
      # @param params [Novabilling::APIKeys::Types::CreateAPIKeyBodyDto]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      # @option request_options [Integer] :timeout_in_seconds
      #
      # @return [Novabilling::Types::APIKeyResponse]
      def create(request_options: {}, **params)
        ...
        request = Novabilling::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "api/tenants/me/api-keys",
          body: Novabilling::APIKeys::Types::CreateAPIKeyBodyDto.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        if code.between?(200, 299)
          Novabilling::Types::APIKeyResponse.load(response.body)
        else
          error_class = Novabilling::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      def delete(request_options: {}, **params)
        ...
        request = Novabilling::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "DELETE",
          path: "api/tenants/me/api-keys/#{params[:id]}",
          request_options: request_options
        )
        begin
          response = @client.send(request)
