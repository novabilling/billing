...
module Novabilling
  module Charges
    class Client
      ...
      #
      # @return [Array[Novabilling::Types::ChargeResponse]]
      def list(request_options: {}, **params)
        params = Novabilling::Internal::Types::Utils.normalize_keys(params)
        query_param_names = %i[plan_id]
        query_params = {}
      ...
      # Create a usage-based charge linking a plan to a billable metric. Supported models: STANDARD, GRADUATED, VOLUME,
      # PACKAGE, PERCENTAGE.
      #
      # @param request_options [Hash]
      # @param params [Novabilling::Charges::Types::CreateChargeDto]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      # @option request_options [Integer] :timeout_in_seconds
      #
      # @return [Novabilling::Types::ChargeResponse]
      def create(request_options: {}, **params)
        ...
        request = Novabilling::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "api/charges",
          body: Novabilling::Charges::Types::CreateChargeDto.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        if code.between?(200, 299)
          Novabilling::Types::ChargeResponse.load(response.body)
        else
          error_class = Novabilling::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @param request_options [Hash]
      # @param params [Novabilling::Charges::Types::UpdateChargeDto]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def update(request_options: {}, **params)
        params = Novabilling::Internal::Types::Utils.normalize_keys(params)
        request_data = Novabilling::Charges::Types::UpdateChargeDto.new(params).to_h
      ...
      #
      # @return [Array[Novabilling::Types::ChargeResponse]]
      def get_by_plan(request_options: {}, **params)
        params = Novabilling::Internal::Types::Utils.normalize_keys(params)
        request = Novabilling::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "GET",
          path: "api/charges/plan/#{params[:plan_id]}",
          request_options: request_options
        )
        begin
          response = @client.send(request)
