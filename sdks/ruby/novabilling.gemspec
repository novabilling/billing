...
require_relative "lib/novabilling/version"
...
Gem::Specification.new do |spec|
  spec.name = "novabilling"
  spec.authors = ["Novabilling"]
  spec.version = Novabilling::VERSION
  spec.summary = "Ruby client library for the Novabilling API"
  spec.description = "The Novabilling Ruby library provides convenient access to the Novabilling API from Ruby."
