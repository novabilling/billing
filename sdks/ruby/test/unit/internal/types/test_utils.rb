...
describe Novabilling::Internal::Types::Utils do
  Utils = Novabilling::Internal::Types::Utils

  module TestUtils
    class M < Novabilling::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Novabilling::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Novabilling::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend Novabilling::Internal::Types::Union
    ...
    SymbolStringHash = Novabilling::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Novabilling::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = Novabilling::Internal::Types::Array[String]
      ModelArray = -> { Novabilling::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Novabilling::Internal::Types::Array[TestUtils::U] }
