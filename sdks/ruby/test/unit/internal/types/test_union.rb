...
describe Novabilling::Internal::Types::Union do
  class Rectangle < Novabilling::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Novabilling::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Novabilling::Internal::Types::Model
