...
describe Novabilling::Internal::Types::Model do
  ...
  class ExampleModel < Novabilling::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Novabilling::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Novabilling::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Novabilling::Internal::Types::Model
